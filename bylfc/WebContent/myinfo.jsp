...
<div  id="right">
<div id="gr1" style="padding-top: 100px;">

<h1 style="margin-top: 30px;margin-left: 100px;">个人资料 <a href="editinfo.jsp" style="font-size:20px; float:right;">编辑资料</a></h1>
...
<tr><th>性别：<%=sex%></th></tr>
<tr><th>地址：<%=address%></th></tr>
<tr><th><a href="followinglist.jsp">你添加的好友(<%=followingnum%>)</a></th></tr>
<tr><th><a href="followerlist.jsp">添加了你的好友(<%=followernum%>)</a></th></tr>
<tr><th><a href="mymessage.jsp">发布的信息(<%=messagenum%>)</a></th> </tr>
